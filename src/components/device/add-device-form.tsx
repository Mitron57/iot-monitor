...
export function AddDeviceForm({ isOpen, onClose }: AddDeviceFormProps) {
        ...
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., SN123456789" {...form.register("serialNumber")} />
              </FormControl>
              {form.formState.errors.serialNumber && (
                <FormMessage>{form.formState.errors.serialNumber.message}</FormMessage>
              )}
            </FormItem>
